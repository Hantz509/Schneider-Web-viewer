...
export default class App extends React.Component<AppProps, AppState> {
    ...
    constructor(props: AppProps) {
        ...
        const usdAssets: USDAssetType[] = StreamConfig.source === "stream"? [
            {name: "Sample 1", url:"${omni.usd_viewer.samples}/public/samples/MEP_Schneider/MEP_Schneider/panels/P5D_panel.usd"},
            {name: "Sample 2", url:"${omni.usd_viewer.samples}/public/samples/MEP_Schneider/MEP_Schneider/panels/P5C.usd"},
        ]
        :
        [
            {name: "Sample 1", url:"./public/samples/MEP_Schneider/MEP_Schneider/panels/P5D_panel.usd"},
            {name: "Sample 2", url:"./public/samples/MEP_Schneider/MEP_Schneider/panels/P5D_panel.usd"},
        ];
